...
<head>
	...
	<title>Register - HKID Card Management System</title>
	...
	<div class="formWrapper">
		<form id="registerForm">
			...
			<div class="inputblock">
				...
				<input type="text" placeholder="Enter your gender [Male / Female]" onkeydown="if(event.key === 'Enter')" />
			</div>
			<div class="inputblock">
				<label for="birth">Date of Birth</label>
				<input type="date" onkeydown="if(event.key === 'Enter')" />
			</div>
			<div class="inputblock">
				<label for="address">Address</label>
				<input type="text"placeholder="Enter your address" onkeydown="if(event.key === 'Enter')" />
			</div>
			<div class="inputblock">
				<label for="occupation">Occupation</label>
				<input type="text" placeholder="Enter your occupation" onkeydown="if(event.key === 'Enter')" />
			</div>
			<br>
