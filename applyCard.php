...
<head>
	...
	<title>Apply - HKID Card Management System</title>
	<link rel="stylesheet" href=<?php echo dirname($_SERVER['PHP_SELF']) . 'style.css' ?> />
</head>
<body>
	<div class="formWrapper">
		<form id="loginForm">
			<h1>Apply or Replace HKID Card</h1>
			<div id="errs" class="errorcontainer"></div>
			<div class="inputblock">
				<label for="date">Available Date</label>
				<input id="date" name="date" type="date" autocomplete="date" min="mon" max="fri" />
			</div>
			<div class="inputblock">
				<label for="time">Time</label>
				<input id="time" name="time" type="time" autocomplete="time" />
			</div>
			<div class="inputblock">
				<label for="password">Venues</label>
			...
			<br>
				<div class="btn" onclick="location.href='submitted.php';">Submit</div>
		</form>
